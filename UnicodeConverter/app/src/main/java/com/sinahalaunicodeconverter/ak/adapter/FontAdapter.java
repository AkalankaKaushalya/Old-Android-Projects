package com.sinahalaunicodeconverter.ak.adapter;
...
import com.sinahalaunicodeconverter.ak.R;
...
public class FontAdapter extends RecyclerView.Adapter<FontAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(activity).inflate(R.layout.font_card, parent, false);
        return new MyViewHolder(row);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
         Font fontmodel = fontItems.get(position);
        holder.title.setText(fontmodel.getFontName());


        StringBuilder strBld = new StringBuilder(fontmodel.getPreviewText());
        ...
        switch (position) {
            ...
            case 7:
                if ("Preview text".equals(fontmodel.getPreviewText())) {
                ...
                } else if (!fontmodel.getPreviewText().contains("♥")) {
            ...
            case 8:
                if ("Preview text".equals(fontmodel.getPreviewText())) {
                    for (int charOne = 0; charOne < strBld.length(); charOne++) {
                        ...
                        if (strBld.length() != charOne && strBld.charAt(charOne) != ' ') {
                            strBld.insert(++charOne, "͚ ");
                        }


                    }

                } else if (!fontmodel.getPreviewText().contains("͚ ")) {
            ...
            case 9:
                if ("Preview text".equals(fontmodel.getPreviewText())) {
                    for (int charOne = 0; charOne < strBld.length(); charOne++) {
                        ...
                        if (strBld.length() != charOne && strBld.charAt(charOne) != ' ') {
                            strBld.insert(++charOne, "⃠ ");
                        }


                    }

                } else if (!fontmodel.getPreviewText().contains("⃠ ")) {
...
//                arrayList.add(̶;
        ...
        fontmodel.setPreviewText(strBld.toString());
        holder.description.setText(fontmodel.getPreviewText());
        ...
        holder.copybtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(activity, "Copied text is " + desStr, Toast.LENGTH_SHORT).show();
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private MyViewHolder(View itemView) {
            super(itemView);
            title = itemView.findViewById(R.id.FonttitleTv);
            description = itemView.findViewById(R.id.FontDescTv);
            copybtn = itemView.findViewById(R.id.CopyTextBtn);
        }
    }
}
