package com.sinhalawelawa.ak.Color_Picer;
 ...
 * @since 2017/08/02
 */
public class ColorPickerDialog extends Dialog implements lk.sanoj.helaclok.pro.HelaClockPro.ColorPickerView.OnColorChangedListener,
        View.OnClickListener, TextView.OnEditorActionListener {

    private lk.sanoj.helaclok.pro.HelaClockPro.ColorPickerView mColorPicker;
    ...
    private void setUp(int color) {
        ...
        mColorPicker = (lk.sanoj.helaclok.pro.HelaClockPro.ColorPickerView) layout.findViewById(R.id.color_picker_view);
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
        if (actionId == EditorInfo.IME_ACTION_DONE) {
            ...
            if (hexVal.length() >= 0 || hexVal.length() < 7) {
                try {
                    int c = lk.sanoj.helaclok.pro.HelaClockPro.Utils.convertToColorInt(hexVal);
    ...
    private void updateHexValue(int color) {
        mEtHex.setText(lk.sanoj.helaclok.pro.HelaClockPro.Utils.convertToRGB(color).toUpperCase(Locale.getDefault()));
        mEtHex.setTextColor(mHexDefaultTextColor);
    }
