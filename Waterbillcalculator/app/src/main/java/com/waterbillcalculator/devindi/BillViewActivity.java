...
import com.waterbillcalculator.devindi.databinding.DialogEditDeleteBinding;
...
public class BillViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numRows == 0) {
            Toast.makeText(BillViewActivity.this, "The Database is empty  :(.", Toast.LENGTH_LONG).show();
        } else {
            int i = 0;
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DialogEditDeleteBinding dialogEditDeleteBinding = DialogEditDeleteBinding.inflate(LayoutInflater.from(BillViewActivity.this));

                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(BillViewActivity.this, R.style.CustomDialog);
                ...
                dialogEditDeleteBinding.datadeletBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (dchek == true) {
                            Toast.makeText(BillViewActivity.this, "Delete Data", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(BillViewActivity.this, "No Delete Data...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                dialogEditDeleteBinding.dataUpdateBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent g = new Intent(BillViewActivity.this, UpdateActivity.class);
