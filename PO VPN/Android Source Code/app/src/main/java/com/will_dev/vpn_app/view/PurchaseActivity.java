...
public class PurchaseActivity extends AppCompatActivity implements  BillingProcessor.IBillingHandler {
    ...
    private void unlock_all(int i) {
        switch (i) {
            case 0:
                bp.subscribe(PurchaseActivity.this, Config.all_month_id);
                break;
            case 1:
                bp.subscribe(PurchaseActivity.this, Config.all_threemonths_id);
                break;
            case 2:
                bp.subscribe(PurchaseActivity.this, Config.all_sixmonths_id);
                break;
            case 3:
                bp.subscribe(PurchaseActivity.this, Config.all_yearly_id);
                break;
        }
    }
